...
class dailyForecast:
    def __init__(self, root, day, row, frame, container_h, container_w, daily_weather, pady):
        ...
        self.day_image = icons.icons(root, self.widget, 2, daily_weather, 17)
